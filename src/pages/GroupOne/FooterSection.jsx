...
export default function FooterSection() {
  ...
  const openLinkedinWindow = () => { window.open('https://www.linkedin.com/in/bartek-dadas-62a756281/'); }
        ...
        <div className="mx-auto flex w-full max-w-[1376px] justify-center self-end px-14 md:px-5">
          <div className="flex flex-col items-start">
            ...
            <div className="mt-2 flex items-center gap-4 self-center">
              <Img src="images/img_frame.svg" alt="Facebook" className="h-[10px] w-[10px]" onClick={openFacebookWindow}/>
              <Img src="images/img_frame_white_a700_14x14.svg" alt="Linkedin" className="h-[14px] w-[14px]" onClick={openLinkedinWindow} />
              <Img src="images/img_frame_white_a700_16x16.svg" alt="Github" className="h-[16px] w-[16px]" onClick={openGithubWindow}/>
            </div>
          </div>
        </div>
      </div>
